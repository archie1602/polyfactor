...
{
    public class PolsRemWithDifferentDegsWhereFirstLessShouldReturnPolsRem : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return new object[]
            {
                ...
                // p1 % p2
                new GFPoly(_gf5, new ulong[] { 0, 0, 4, 4, 3, 4, 3, 4 })
            };
        }
    }
}