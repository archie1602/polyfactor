...
{
    public class SubPolsWithDifferentDegsWhereFirstLessShouldSubPols : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                ...
                // p1 - p2
                new GFPoly(_gf5, new ulong[] { 1, 4, 1, 1 })
            };
            ...
            yield return new object[]
            {
                ...
                // p1 - p2
                new GFPoly(_gf5, new ulong[] { 0, 1, 1, 0, 4, 2 })
            };
            ...
            yield return new object[]
            {
                ...
                // p1 - p2
                new GFPoly(_gf5, new ulong[] { 1, 4, 2, 1, 4, 4, 3, 4, 0, 0, 0, 1, 1 })
            };
        }
    }
}
