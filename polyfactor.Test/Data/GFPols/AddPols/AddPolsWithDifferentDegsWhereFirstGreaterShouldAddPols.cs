...
{
    public class AddPolsWithDifferentDegsWhereFirstGreaterShouldAddPols : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                ...
                // p1 + p2
                new GFPoly(_gf5, new ulong[] { 0, 4, 3 })
            };
            ...
            yield return new object[]
            {
                ...
                // p1 + p2
                new GFPoly(_gf5, new ulong[] { 0, 0, 0, 4, 3 })
            };
            ...
            yield return new object[]
            {
                ...
                // p1 + p2
                new GFPoly(_gf5, new ulong[] { 3, 0, 3, 2, 2, 4, 3, 4 })
            };
        }
    }
}